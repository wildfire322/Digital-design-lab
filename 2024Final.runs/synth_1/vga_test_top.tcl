...
namespace eval ::optrace {
  variable script "F:/LDFEXP/2024Final/2024Final.runs/synth_1/vga_test_top.tcl"
...
read_verilog -library xil_defaultlib {
  ...
  F:/LDFEXP/2024Final/VGA/vga_test_top.v
}
...
synth_design -top vga_test_top -part xc7k160tffg676-2L
...
write_checkpoint -force -noxdef vga_test_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file vga_test_top_utilization_synth.rpt -pb vga_test_top_utilization_synth.pb"
